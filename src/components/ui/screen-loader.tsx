...
export function ScreenLoader({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-black/20 dark:bg-black/60 backdrop-blur-md transition-all duration-300 animate-in fade-in-0">
      <div className="flex flex-col items-center space-y-5 p-8 rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-2xl max-w-sm text-center">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="absolute -inset-2 rounded-3xl border-2 border-black/20 border-t-black dark:border-white/20 dark:border-t-white animate-spin" />
        </div>
