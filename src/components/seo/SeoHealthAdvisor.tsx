...
export function SeoHealthAdvisor({
  ...
  return (
    <div className="border border-border rounded-xl bg-card shadow-2xs overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between p-3.5 text-sm font-bold text-foreground border-b border-border bg-muted/30">
      ...
      {/* Body */}
      <div className={`p-4 space-y-4 ${isCalculating ? "opacity-70" : "opacity-100"} transition-opacity`}>
        {!hasKeyword ? (
